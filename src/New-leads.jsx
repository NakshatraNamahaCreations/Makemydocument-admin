...
{ selectedLead?.service !== "PassPort" &&  selectedLead?.service !== "Travel Visa" && (
  ...
  {selectedLead?.source !== "contact page" &&  selectedLead?.source !== "Blog page" &&(
    <>
{selectedLead?.service !== "Rental Agreement" && selectedLead?.service !== "Lease Agreement" && selectedLead?.service !== "Pancard" && selectedLead?.service !== "PassPort" &&  selectedLead?.service !== "SeniorCitizen" &&(
    <div style={styles.col}>

...
import { setClr } from "./redux/clrSlice"; 
...
const getStatusLabel = (status, followupDate) => {
  ...
  console.log("clearioi",clear)
  const handleRowClick = (lead) => {
    console.log("Clicked lead:", lead);
    dispatch(setClr(true))
  ...
  console.log("yogi00",selectedLead)
  ...
  return (
    <>
     <Helmet>
    <title>Search - Make my Documents</title>
...
>
  ...
  <td style={{ padding: "10px", minWidth: "200px" }}>
    ...
    >
      ...
      <tr>
        <td colSpan={adminData?.role === "admin" ? "6" : "5"} style={{ textAlign: "center", padding: "8px" }}>
          No data available
        </td>
      </tr>
    )}
